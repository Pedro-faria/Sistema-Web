...
<html>
	...
	<head>
	<title>Especialistas Cadastrados</title>
...
$query = sprintf("SELECT id,nome,email, nascimento, cidade, endereco, area_atuacao, experiencia_profissional, site FROM consultores");
// executa a query
...
?>
 ...
 <div id="main" class="container-fluid" style="margin-top: 50px">
  ...
  <div id="top" class="row">
    ...
    <div class="col-sm-3">
      <a href="Cad_Consultores.php" class="btn btn-primary pull-right h2">Novo Consultor</a>
    </div>
  </div> <!-- /#top -->
  <hr />
        ...
        <tr>
		  ...
		  <?php
            // <a class="btn btn-success btn-xs" href="view.html">Visualizar</a>
             echo '<a class="btn btn-warning btn-xs" href="editar.php?id='.$linha['id'].'">[Editar]</a>';
             echo '<a class="btn btn-danger btn-xs" href="deletar.php?id='.$linha['id'].'">[deletar]</a>';
			?>
		  </td>
        </tr>
              </tbody>
